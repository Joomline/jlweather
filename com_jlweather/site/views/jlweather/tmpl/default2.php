...
?>
		<style type="text/css">
			.jlwdate {
              ...
              dt.open { width: 80px; background-color: #CCFFFF; font-size: 16px; font-weight: bold; float: left; height: 20px; margin-left: 5px; margin-right: 5px; padding-left: 10px; padding-right: 10px; padding-top: 10px; padding-bottom: 10px }
              dt.closed { width: 80px; background-color: #DFDFDF; font-size: 16px; font-weight: bold; float: left; height: 20px; margin-left: 5px; margin-right: 5px; padding-left: 10px; padding-right: 10px; padding-top: 10px; padding-bottom: 10px }
              dd { display: none }

		</style>
<table cellpadding="5" cellspacing="5" border="0">
  <tr style="padding-top:10px;" >
    <td class="jlwitem" width="670">
    <?php jimport('joomla.html.pane');
          $pane =& JPane::getInstance('Tabs');
          echo $pane->startPane('myPane');
          { ?>
  <?php foreach ($this->forecast as $date=>$daypart) : ?>
    <?php echo $pane->startPanel($date.'1', $date.'2'); ?>
      <div  >
<table cellpadding="5" cellspacing="5" border="0" style="display: inline; margin-top: 50px">
