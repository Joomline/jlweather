...
<p><?=JText::_('DESC_ADMIN') ?></p>
<p><?=JText::_('DESC_WEATER') ?></p>
<p><?=JText::_('DESC_DEVELOPERS') ?></p>
<p><?=JText::_('COM_JLWEATHER_DESC_SETTINGS') ?></p>
<p></p>
    <h1>Donate (ѕожертвовани€)</h1>
<div class="donate">
    <h2>ƒл€ –оссии и ”краины</h2>
        ...
        <tr>
            ...
            <td align="center">
                <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
                    ...
                    <input type="image" src="https://www.paypalobjects.com/en_US/GB/i/btn/btn_donateCC_LG.gif" border="0" name="submit" alt="PayPal Ч The safer, easier way to pay online.">
